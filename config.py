...
CLASSIFIER_PATHS = {
    ...
    "EYE": os.path.join(MODEL_DIR, "classifier/efficientnet_b0_eye_v2/efficientnet_b0_best.pth"),
...
CLASS_MAPPING_PATHS = {
    ...
    "EYE": os.path.join(MODEL_DIR, "classifier/efficientnet_b0_eye_v2/class_mapping.json"),
